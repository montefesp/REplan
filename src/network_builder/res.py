...
def add_generators_per_bus(network: pypsa.Network, wind_costs: Dict[str, float],
...
def add_generators_without_siting(network: pypsa.Network, wind_costs: Dict[str, float],
                                        pv_costs: Dict[str, float]) -> pypsa.Network:
