...
def build_model_docplex(resite, cap_per_tech: List[float]):
    ...
    from src.resite.models.docplex_utils import maximize_load_proportion, tech_cap_bigger_than_limit, \
...
def build_model_gurobipy(resite, cap_per_tech: List[float]):
    ...
    from src.resite.models.gurobipy_utils import generation_bigger_than_load_x, capacity_bigger_than_existing, \
...
def build_model_pyomo(resite, cap_per_tech: List[float]):
    ...
    from src.resite.models.pyomo_utils import tech_cap_bigger_than_limit, maximize_load_proportion, \
