...
def add_batteries(network: pypsa.Network, battery_type: str, buses_ids: List[str] = None,
    ...
    if fixed_duration:
        ...
        capital_cost, marginal_cost, _ = get_costs(battery_type, sum(network.snapshot_weightings))
        ...
        capital_cost, marginal_cost, _ = get_costs(battery_type_power, sum(network.snapshot_weightings['objective']))
        capital_cost_e, marginal_cost_e, _ = get_costs(battery_type_energy, sum(network.snapshot_weightings['objective']))
