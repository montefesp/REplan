...
def add_phs_plants(net: pypsa.Network, topology_type: str = "countries",
    ...
    capital_cost, marginal_cost, _ = get_costs('phs', sum(net.snapshot_weightings['objective']))
...
def add_ror_plants(net: pypsa.Network, topology_type: str = "countries",
    ...
    # Get cost and efficiencies
    capital_cost, marginal_cost, _ = get_costs('ror', sum(net.snapshot_weightings['objective']))
...
def add_sto_plants(net: pypsa.Network, topology_type: str = "countries",
    ...
    capital_cost, marginal_cost, _ = get_costs('sto', sum(net.snapshot_weightings['objective']))
